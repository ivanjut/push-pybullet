...
from ss_pybullet.pybullet_tools.kuka_primitives import BodyPose, BodyConf, Command, get_grasp_gen, \
    get_ik_fn, get_free_motion_gen, get_holding_motion_gen
from ss_pybullet.pybullet_tools.utils import WorldSaver, enable_gravity, connect, dump_world, set_pose, \
...
def main(display='execute'): # control | execute | step
    ...
    floor = load_model('ss_pybullet/models/short_floor.urdf')
